...
//Time-to-Trigger Matrix
#define TTT_NOT_SET -1
...
#define MEASUREMENT_REPORT_NEXT(mem) (mem = LIST_NEXT(mem))
#pragma endregion

#pragma region RRC_TTT

	typedef struct stru_LTENR_gNB_HO_Trigger {
		NETSIM_ID gnbID;
		NETSIM_ID gnbIF;
		double TriggerTime;
		_ele* ele;
	}LTENR_gNB_HO_Trigger, * ptrLTENR_gNB_HO_Trigger;

#define HO_TRIGGER_ALLOC() (struct stru_LTENR_gNB_HO_Trigger*)list_alloc(sizeof(struct stru_LTENR_gNB_HO_Trigger),offsetof(struct stru_LTENR_gNB_HO_Trigger,ele))
#define HO_TRIGGER_REMOVE(ls, mem) (LIST_FREE((void**)(ls),(mem)))
#define HO_TRIGGER_REPORT_NEXT(mem) (mem = LIST_NEXT(mem))

	typedef struct stru_LTENR_Conditional_HO_TTT_Matrix {
		NETSIM_ID ueID;
		NETSIM_ID ueIF;
		ptrLTENR_gNB_HO_Trigger gNB_HO_Trigger;
		_ele* ele;
	}LTENR_Conditional_HO_TTT_Matrix, * ptrLTENR_Conditional_HO_TTT_Matrix;

#define HO_TTT_MATRIX_ALLOC() (struct stru_LTENR_Conditional_HO_TTT_Matrix*)list_alloc(sizeof(struct stru_LTENR_Conditional_HO_TTT_Matrix),offsetof(struct stru_LTENR_Conditional_HO_TTT_Matrix,ele))
#define HO_TTT_MATRIX_REMOVE(ls, mem) (LIST_FREE((void**)(ls),(mem)))
#define HO_TTT_MATRIX_NEXT(mem) (mem = LIST_NEXT(mem))
#pragma endregion
...
#pragma region RRC_Entity
	...
	typedef struct stru_LTENR_GNBRRC
	{
		...
		ptrLTENR_Conditional_HO_TTT_Matrix Conditional_HO_TTT_Matrix;
		double T300;
...
#define SINR_REPORT_REMOVE(ls, mem) (LIST_FREE((void**)(ls),(mem)))
	typedef struct stru_LTENR_UERRC
	{
		...
		bool isSecondaryAssociated;
		double InteruptionInterval;
		double InteruptionEndTime;
		bool isMNHandoverComplete;
