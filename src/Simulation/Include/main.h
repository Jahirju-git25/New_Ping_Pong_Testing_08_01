...
#endif
# define fnDlError(x,...) ReportError(false,x,__LINE__,__FILE__,1,__VA_ARGS__)
#define fnSystemError(x,...) ReportError(false,x,__LINE__,__FILE__,1,__VA_ARGS__)
# define fnNetSimError(x,...) ReportError(false,x,__LINE__,__FILE__,0,__VA_ARGS__)
#define fnNetSimErrorandStop(x,...) ReportError(true,x,__LINE__,__FILE__,0,__VA_ARGS__)
...
# define fn_NetSim_Utilities_LoadSharedlibFunction(hsharedlib,sharedlibName,funName) fn_NetSim_Utilities_LoadSharedlibFunction_dbg(hsharedlib,sharedlibName,funName,__LINE__,__FILE__)
	...
	_declspec(dllexport) int ReportError(bool isStopOnError, const char* msg, int line, const char* file, int flag, ...);
...
#define fnpAddEvent(pstruEvent) fnAddEvent_F(pstruEvent,__LINE__,__FILE__)
	...
	_declspec(dllexport) unsigned long long int fnAddEvent_F(struct stru_NetSim_EventDetails* pstruEvent, int line, const char* file);
