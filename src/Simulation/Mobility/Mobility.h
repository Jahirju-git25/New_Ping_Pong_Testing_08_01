...
#define Mobility_OPEN_MOBILITY_FILE_DEFAULT		_strdup("")
...
#define Mobility_STOP_DURATION_S_DEFAULT		5
	...
	double dOrigin_X; //Store the origin_x
	double dOrigin_Y; //Store the origin_y
	double dGridWidth; //Store the grid width
	double dGridLength; //Store the grid length
	double dGridMax_x; //Store the grid max_x
	double dGridMax_y; //Store the grid max_y
	...
	void log_mobility(MOVENODE log);
